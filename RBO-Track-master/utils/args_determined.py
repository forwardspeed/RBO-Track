...
def make_parser():
    parser = argparse.ArgumentParser("Determined Track parameters")
    ...
    # tracking args
    parser.add_argument("--init_thresh", type=float, default=0.4, help="detection confidence threshold")
    parser.add_argument("--determined_thresh", type=float, default=0.8, help="detection_determined confidence threshold")
    parser.add_argument("--iou_thresh", type=float, default=0.3, help="the iou threshold in Sort for matching")
    parser.add_argument("--emb_thresh", type=float, default=0.3, help="the emb threshold in Sort for matching")
    ...
    parser.add_argument("--with_fastreid", dest="with_fastreid", default=False, action="store_true",
                        help="use FastReID flag.")
    parser.add_argument("--fast_reid_config", dest="fast_reid_config",
                        default=r"fast_reid/configs/CUHKSYSU_DanceTrack/sbs_S50.yml", type=str,
                        help="reid config file path")
    parser.add_argument("--fast_reid_weights", dest="fast_reid_weights",
                        default=r"fast_reid/logs/CUHKSYSU_DanceTrack/sbs_S50/model_final.pth", type=str,

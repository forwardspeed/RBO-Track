...
from yolox.evaluators import ByteOc as MOTEvaluator
...
def main(exp, args, num_gpu):
    ...
    result_dir = "{}_test".format(args.expn) + \
                 "_init" + str(args.init_thresh) + \
                 "_determined" + str(args.determined_thresh) + \
                 "_IoUThresh" + str(args.iou_thresh) + "_EmbThresh" + str(args.emb_thresh) +\
                 "_testconf" + str(args.conf)\
        if args.test else \
    ...
    # start tracking
    *_, summary = evaluator.evaluator_byte_oc_track(

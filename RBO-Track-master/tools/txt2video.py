...
def txt2img(visual_path="visual_val_gt"):
    ...
    test_show_video_names = ['MOT17-01-FRCNN', 
                    ...
                    'MOT17-12-FRCNN',
                    'MOT17-14-FRCNN']
    train20_json_path = 'datasets/MOT20/annotations/val_half.json'
    train20_img_path = 'datasets/MOT20/train/'
    train20_show_video_names = ['MOT20-01',
                             'MOT20-02',
                             'MOT20-03',
                             'MOT20-05']
    ...
    if visual_path == "visual_train20_predict":
        show_video_names = train20_show_video_names
        img_path = train20_img_path
        gt_json_path = train20_json_path
    for show_video_name in show_video_names:
        ...
        if visual_path == "visual_val_gt":
            ...
            txt_path = 'YOLOX_outputs/byte_oc/' + show_video_name + '.txt'
        elif visual_path == "visual_test_predict":
            txt_path = 'YOLOX_outputs/test/' + show_video_name + '.txt'
        elif visual_path == "visual_train20_predict":
            txt_path = 'YOLOX_outputs/train20/' + show_video_name + '.txt'
        else:
...
if __name__ == '__main__':
    ...
    # visual_path = "visual_train20_predict"
    if len(sys.argv) > 1:
